...
LangString qwenpawCliPathPageSubtitle ${LANG_PORTUGUESEBR} "Choose whether drclaw is available in terminals."
LangString qwenpawCliPathPageDescription ${LANG_PORTUGUESEBR} "This adds the bundled drclaw command to your user PATH. You can change it later by reinstalling or uninstalling Dr.Claw Desktop."
LangString qwenpawCliPathCheckbox ${LANG_PORTUGUESEBR} "Add drclaw to PATH"
LangString qwenpawCliPathAdded ${LANG_PORTUGUESEBR} "Added drclaw to user PATH"
LangString qwenpawCliPathSkipped ${LANG_PORTUGUESEBR} "Skipped adding drclaw to user PATH"
LangString qwenpawCliPathMissing ${LANG_PORTUGUESEBR} "drclaw.exe was not found; skipped PATH update"
LangString qwenpawCliPathUpdateFailed ${LANG_PORTUGUESEBR} "Failed to update user PATH"
LangString qwenpawStopBackendPrompt ${LANG_PORTUGUESEBR} "O Dr.Claw ainda está em execução e está usando arquivos que o instalador precisa substituir.$\n$\nFeche o Dr.Claw (verifique a bandeja do sistema) e clique em Repetir para continuar. Clique em Cancelar para abortar a instalação."
