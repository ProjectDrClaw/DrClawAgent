...
LangString qwenpawCliPathPageSubtitle ${LANG_ENGLISH} "Choose whether drclaw is available in terminals."
LangString qwenpawCliPathPageDescription ${LANG_ENGLISH} "This adds the bundled drclaw command to your user PATH. You can change it later by reinstalling or uninstalling Dr.Claw Desktop."
LangString qwenpawCliPathCheckbox ${LANG_ENGLISH} "Add drclaw to PATH"
LangString qwenpawCliPathAdded ${LANG_ENGLISH} "Added drclaw to user PATH"
LangString qwenpawCliPathSkipped ${LANG_ENGLISH} "Skipped adding drclaw to user PATH"
LangString qwenpawCliPathMissing ${LANG_ENGLISH} "drclaw.exe was not found; skipped PATH update"
LangString qwenpawCliPathUpdateFailed ${LANG_ENGLISH} "Failed to update user PATH"
LangString qwenpawStopBackendPrompt ${LANG_ENGLISH} "Dr.Claw is still running and is using files the installer needs to replace.$\n$\nPlease quit Dr.Claw (check the system tray), then click Retry to continue. Click Cancel to abort the installation."
