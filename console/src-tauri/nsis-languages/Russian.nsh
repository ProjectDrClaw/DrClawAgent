...
LangString qwenpawCliPathPageSubtitle ${LANG_RUSSIAN} "Choose whether drclaw is available in terminals."
LangString qwenpawCliPathPageDescription ${LANG_RUSSIAN} "This adds the bundled drclaw command to your user PATH. You can change it later by reinstalling or uninstalling Dr.Claw Desktop."
LangString qwenpawCliPathCheckbox ${LANG_RUSSIAN} "Add drclaw to PATH"
LangString qwenpawCliPathAdded ${LANG_RUSSIAN} "Added drclaw to user PATH"
LangString qwenpawCliPathSkipped ${LANG_RUSSIAN} "Skipped adding drclaw to user PATH"
LangString qwenpawCliPathMissing ${LANG_RUSSIAN} "drclaw.exe was not found; skipped PATH update"
LangString qwenpawCliPathUpdateFailed ${LANG_RUSSIAN} "Failed to update user PATH"
LangString qwenpawStopBackendPrompt ${LANG_RUSSIAN} "Dr.Claw всё ещё запущен и использует файлы, которые установщику нужно заменить.$\n$\nЗакройте Dr.Claw (проверьте системный трей), затем нажмите «Повторить», чтобы продолжить. Нажмите «Отмена», чтобы прервать установку."
