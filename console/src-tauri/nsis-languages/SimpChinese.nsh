...
LangString qwenpawCliPathPageSubtitle ${LANG_SIMPCHINESE} "选择是否让终端可以直接使用 drclaw。"
LangString qwenpawCliPathPageDescription ${LANG_SIMPCHINESE} "这会把随包提供的 drclaw 命令加入你的用户 PATH。之后可通过重新安装或卸载 Dr.Claw Desktop 变更。"
LangString qwenpawCliPathCheckbox ${LANG_SIMPCHINESE} "将 drclaw 添加到 PATH"
LangString qwenpawCliPathAdded ${LANG_SIMPCHINESE} "已将 drclaw 添加到用户 PATH"
LangString qwenpawCliPathSkipped ${LANG_SIMPCHINESE} "已跳过添加 drclaw 到用户 PATH"
LangString qwenpawCliPathMissing ${LANG_SIMPCHINESE} "未找到 drclaw.exe，已跳过 PATH 更新"
LangString qwenpawCliPathUpdateFailed ${LANG_SIMPCHINESE} "更新用户 PATH 失败"
LangString qwenpawStopBackendPrompt ${LANG_SIMPCHINESE} "Dr.Claw 仍在运行，正占用安装程序需要替换的文件。$\n$\n请先退出 Dr.Claw（注意查看系统托盘），然后点击“重试”继续；点击“取消”将中止安装。"
