...
LangString qwenpawCliPathPageSubtitle ${LANG_JAPANESE} "Choose whether drclaw is available in terminals."
LangString qwenpawCliPathPageDescription ${LANG_JAPANESE} "This adds the bundled drclaw command to your user PATH. You can change it later by reinstalling or uninstalling Dr.Claw Desktop."
LangString qwenpawCliPathCheckbox ${LANG_JAPANESE} "Add drclaw to PATH"
LangString qwenpawCliPathAdded ${LANG_JAPANESE} "Added drclaw to user PATH"
LangString qwenpawCliPathSkipped ${LANG_JAPANESE} "Skipped adding drclaw to user PATH"
LangString qwenpawCliPathMissing ${LANG_JAPANESE} "drclaw.exe was not found; skipped PATH update"
LangString qwenpawCliPathUpdateFailed ${LANG_JAPANESE} "Failed to update user PATH"
LangString qwenpawStopBackendPrompt ${LANG_JAPANESE} "Dr.Claw がまだ実行中で、インストーラーが置き換える必要のあるファイルを使用しています。$\n$\nDr.Claw を終了してから（システムトレイをご確認ください）、「再試行」をクリックして続行してください。「キャンセル」をクリックするとインストールを中止します。"
